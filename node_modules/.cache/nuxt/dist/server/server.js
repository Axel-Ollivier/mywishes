...
/******/ 			var chunk = require("./" + ({"1":"pages/account","2":"pages/index","3":"pages/userWishes"}[chunkId]||chunkId) + ".js");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(5).default("3e7ab538", content, true)
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".hidden{display:none!important}.special-elite{font-family:\"Special Elite\",cursive}", ""]);
// Exports
module.exports = exports;
...
const _be1c0c5a = () => interopDefault(__webpack_require__.e(/* import() | pages/account */ 1).then(__webpack_require__.bind(null, 37)));

const _a89430ec = () => interopDefault(__webpack_require__.e(/* import() | pages/userWishes */ 3).then(__webpack_require__.bind(null, 38)));

const _309d4978 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 36))); // TODO: remove in Nuxt 3
...
/* harmony default export */ var nuxt_axios = ((ctx, inject) => {
  ...
  const baseURL =  false ? undefined : runtimeConfig.baseURL || process.env._AXIOS_BASE_URL_ || 'https://api-mywishes.herokuapp.com/'; // Create fresh objects for all default header scopes
